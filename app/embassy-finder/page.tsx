    ...
    <div className="min-h-screen bg-[#FAFAFA] text-[#0f0c29] antialiased">
      ...
      <section className="relative overflow-hidden pt-20 pb-16 text-center">
        ...
        <div className="relative mx-auto max-w-3xl px-4">
          ...
          <p className="mx-auto mt-6 max-w-md text-base text-gray-500 sm:text-lg">Locate embassies and consulates worldwide with contact details and opening hours.</p>
      ...
      {results !== null && (
        <section className="pb-24 px-4">
          <div className="mx-auto max-w-2xl space-y-4">
            {results.length === 0 ? (
              <div className="text-center rounded-2xl border border-gray-100 bg-white p-12">
                <div className="text-5xl mb-4">🏛️</div>
                <p className="font-semibold text-gray-500">No embassy found for this combination.</p>
                <p className="mt-1 text-sm text-gray-400">Try a different passport or destination country.</p>
              </div>
            ) : results.map((e, i) => (
